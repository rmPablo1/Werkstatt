 ...
 * @author pablo
 */
public class FormularioCoche extends javax.swing.JFrame {
    ...
    private void anyadirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_anyadirMouseClicked
            ...
            Logger.getLogger(FormularioCoche.class.getName()).log(Level.SEVERE, null, ex);
        }
            try{
            Connection conn = DriverManager.getConnection(URL, "root", "admin");
            ...
            Logger.getLogger(FormularioCoche.
                    class.getName()).log(Level.SEVERE, null, ex);
        }
             javax.swing.JOptionPane.showMessageDialog(this, "Nuevo registro insertado");
