 ...
 * @author pablo
 */
public class AdminEN extends javax.swing.JFrame {
    int idioma=1;
    ...
    private void initComponents() {
        ...
        arreglosPorHacer.setText("REPAIRS TO DO ");
        ...
        ingresarNuevoCoche.setText("ADD CAR");
        ...
        arreglosYaTerminados.setText("REPAIRED CARS");
        arreglosYaTerminados.setToolTipText("");
        ...
        matriculaTerminada.setText("ADD CAR PLATE");
        ...
        terminado.setText("REPAIRED");
        terminado.setActionCommand("REPAI");
    ...
    private void arreglosPorHacerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_arreglosPorHacerMouseClicked
        ...
        try {
            ...
            Logger.getLogger(AdminEN.class.getName()).log(Level.SEVERE, null, ex);
        }
        for (Coche c : coches) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
